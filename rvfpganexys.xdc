...
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { i_pshbutton[0] }]; #BTNC
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { i_pshbutton[1] }]; #BTNU
set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { i_pshbutton[2] }]; #BTNL
set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { i_pshbutton[3] }]; #BTNR
set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports { i_pshbutton[4] }]; #BTND
...
#################################################
## Pmod Header JD
###	Pmod for PWM communication with horizontal and vertival SERVOs
#
#############################################
set_property -dict { PACKAGE_PIN H4    IOSTANDARD LVCMOS33 } [get_ports { jd[0] }]; #IO_L11N_T1_SRCC_35 Sch=jd[1] pitch
set_property -dict { PACKAGE_PIN H1    IOSTANDARD LVCMOS33 } [get_ports { jd[1] }]; #IO_L12N_T1_MRCC_35 Sch=jd[2] yaw
...
#################################################
##Pmod Header JA
###	Pmod for i2c communication with LIDAR sensor
#
#############################################
##set_property -dict { PACKAGE_PIN C17   IOSTANDARD LVCMOS33 } [get_ports { SCL }]; #IO_L20N_T3_A19_15 Sch=ja[1]
...
#################################################
##LCD Screen - Pmod JB
###	Pmod for i2c communication with LCD DISPLAY
#
#############################################
##set_property -dict { PACKAGE_PIN F13   IOSTANDARD LVCMOS33 } [get_ports { i_lcd_reg_sel }]; #RS  
##set_property -dict { PACKAGE_PIN G13   IOSTANDARD LVCMOS33 } [get_ports { i_lcd_rw }];      #R/nW
##set_property -dict { PACKAGE_PIN H16   IOSTANDARD LVCMOS33 } [get_ports { i_lcd_en }];      #E   
##set_property -dict { PACKAGE_PIN D14   IOSTANDARD LVCMOS33 } [get_ports { o_lcd_Data[0] }]; #DB0 
##set_property -dict { PACKAGE_PIN F16   IOSTANDARD LVCMOS33 } [get_ports { o_lcd_Data[1] }]; #DB1 
##set_property -dict { PACKAGE_PIN G16   IOSTANDARD LVCMOS33 } [get_ports { o_lcd_Data[2] }]; #DB2 
##set_property -dict { PACKAGE_PIN H14   IOSTANDARD LVCMOS33 } [get_ports { o_lcd_Data[3] }]; #DB3 
##set_property -dict { PACKAGE_PIN E16   IOSTANDARD LVCMOS33 } [get_ports { o_lcd_Data[4] }]; #DB4 
##set_property -dict { PACKAGE_PIN F13   IOSTANDARD LVCMOS33 } [get_ports { o_lcdData[5] }];  #DB5 
##set_property -dict { PACKAGE_PIN G13   IOSTANDARD LVCMOS33 } [get_ports { o_lcdData[6] }];  #DB6 
##set_property -dict { PACKAGE_PIN H16   IOSTANDARD LVCMOS33 } [get_ports { o_lcdData[7] }];  #DB7 
